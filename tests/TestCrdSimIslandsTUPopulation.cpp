...
int main() {
  ...
  try {
    ...
    EGTTools::RL::DataTypes::DataTableCRD results = sim.run_population_islandsTU(nb_evaluation_games,
                                                                                 nb_populations,
                                                                                 population_size,
                                                                                 group_size,
                                                                                 nb_generations,
    ...
    EGTTools::OutputHandler::writeToCSVFile("testIslandsTUPopulation.csv", header, results.data);
