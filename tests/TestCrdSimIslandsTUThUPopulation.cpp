...
int main() {
  ...
  try {
    ...
    EGTTools::RL::DataTypes::DataTableCRD results = sim.run_population_islandsTUThU(nb_evaluation_games,
                                                                                    nb_populations,
                                                                                    population_size,
                                                                                    group_size,
                                                                                    nb_generations,
    ...
    EGTTools::OutputHandler::writeToCSVFile("testIslandsTUThUPopulation.csv", header, results.data);
