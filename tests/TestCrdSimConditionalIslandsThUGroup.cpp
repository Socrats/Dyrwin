...
int main() {
  ...
  try {
    ...
    EGTTools::RL::DataTypes::DataTableCRD results = sim.run_conditional_group_islandsThU(nb_evaluation_games,
                                                                             nb_groups,
                                                                             group_size,
                                                                             nb_generations,
                                                                             nb_games,
    ...
    EGTTools::OutputHandler::writeToCSVFile("testIslandsThUConditionalGroup.csv", header, results.data);
