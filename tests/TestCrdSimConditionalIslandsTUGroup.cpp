...
int main() {
  ...
  try {
    ...
    EGTTools::RL::DataTypes::DataTableCRD results = sim.run_conditional_group_islandsTU(nb_evaluation_games,
                                                                                        nb_groups,
                                                                                        group_size,
                                                                                        nb_generations,
                                                                                        nb_games,
    ...
    EGTTools::OutputHandler::writeToCSVFile("testIslandsTUConditionalGroup.csv", header, results.data);
