...
int main() {
  ...
  try {
    ...
    EGTTools::RL::DataTypes::DataTableCRD results = sim.run_conditional_population_islands(nb_evaluation_games,
                                                                                           nb_populations,
                                                                                           population_size,
                                                                                           group_size,
                                                                                           nb_generations,
    ...
    EGTTools::OutputHandler::writeToCSVFile("testIslandsConditionalPopulation.csv", header, results.data);
