...
EGTTools::SED::NormalFormGame::NormalFormGame(size_t nb_rounds,
  ...
  EGTTools::SED::NormalFormGame::calculate_payoffs();
  // Initialize cooperation level vector
}
void EGTTools::SED::NormalFormGame::play(const EGTTools::SED::StrategyCounts &group_composition,
                                         EGTTools::SED::PayoffVector &game_payoffs) {
  // Initialize payoffs
...
const EGTTools::SED::GroupPayoffs &EGTTools::SED::NormalFormGame::calculate_payoffs() {
  size_t s1, s2;
...
double EGTTools::SED::NormalFormGame::calculate_fitness(const size_t &player_type,
...
double EGTTools::SED::NormalFormGame::calculate_cooperation_level(size_t pop_size,
...
size_t EGTTools::SED::NormalFormGame::nb_strategies() const {
  return nb_strategies_;
}
size_t EGTTools::SED::NormalFormGame::nb_rounds() const {
  return nb_rounds_;
}
size_t EGTTools::SED::NormalFormGame::nb_states() const {
  return nb_states_;
}
std::string EGTTools::SED::NormalFormGame::toString() const {
  return "Normal-form Game.\n"
         "For now the only available strategies are C and D";
}
std::string EGTTools::SED::NormalFormGame::type() const {
  return "NormalFormGame";
}
const EGTTools::SED::GroupPayoffs &EGTTools::SED::NormalFormGame::payoffs() const {
  return payoffs_;
}
const EGTTools::Matrix2D &EGTTools::SED::NormalFormGame::expected_payoffs() const {
  return expected_payoffs_;
}
double EGTTools::SED::NormalFormGame::payoff(size_t strategy,
                                             const EGTTools::SED::StrategyCounts &group_composition) const {
...
void EGTTools::SED::NormalFormGame::save_payoffs(std::string file_name) const {
  // Save payoffs
...
void EGTTools::SED::NormalFormGame::_update_cooperation_and_payoffs(size_t s1, size_t s2) {
  // Initialize payoffs
