...
#ifndef DYRWIN_RL_SARSAAGENT_H
#define DYRWIN_RL_SARSAAGENT_H
...
namespace EGTTools::RL {
    ...
    public:
        SARSAAgent(size_t nb_states, size_t nb_actions, size_t episode_length, double endowment, double alpha,
